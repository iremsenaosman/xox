  ...
  , gameMode_(GAME_MODE_INIT)
{
    ...
    selectSinglePlayerWidget_ = new SelectSinglePlayerWidget(this);
    connect(selectSinglePlayerWidget_, SIGNAL(clickedOk()), SLOT(onSelectSinglePlayerWidgetClickedOk()));
    connect(selectSinglePlayerWidget_, SIGNAL(clickedCancel()), SLOT(onSelectSinglePlayerWidgetClickedCancel()));
    selectSinglePlayerWidget_->hide();
...
void ClientMainWindow::onWelcomeWidgetClickedSinglePlayer()
{
    ...
    ui->centralwidget = selectSinglePlayerWidget_;
...
void ClientMainWindow::onSelectSinglePlayerWidgetClickedOk()
{
...
void ClientMainWindow::onSelectSinglePlayerWidgetClickedCancel()
{
    ui->centralwidget->hide();
    ui->centralwidget = welcomeWidget_;
    ui->centralwidget->show();
        ...
        if (cell != CELL_NONE)
        {
            ...
            else
            {
                Cell aiMove = ai_.getMove(gamePlayWidget_->getBoard(),
                                         PIECE_TYPE_O,
                                         selectSinglePlayerWidget_->getSinglePlayer());
